@testset "Data Reader Tests" begin
    ...
    json_data =
        Dict("inputs" => ["feature1", "feature2"], "norm" => [[0.0, 3.0], [0.0, 6.0]])
    ...
    @testset "verify_normalized_features" begin
        ...
        @test verify_normalized_features(
            csv_path,
            json_path,
            reference_path,
            target_col = "y",
